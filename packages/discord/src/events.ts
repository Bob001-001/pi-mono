...
// ============================================================================
// Synthetic event structure (what gets passed to handler)
// ============================================================================

export interface SyntheticDiscordMessage {
	channelId: string;
	text: string;
	userId: string;
	messageId: string;
...
export class EventsWatcher {
	...
	private execute(filename: string, event: DiscordEvent, deleteAfter: boolean = true): void {
		...
		const syntheticMessage: SyntheticDiscordMessage = {
		...
		const enqueued = this.bot.enqueueEvent(syntheticMessage);

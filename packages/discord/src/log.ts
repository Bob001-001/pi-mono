...
// ============================================================================
// Structured logging for Discord bot (mirrors mom's log.ts)
// ============================================================================
...
export function logStartup(workingDir: string, agentName: string): void {
	console.log("Starting Discord bot...");
	console.log(`  Agent: ${agentName}`);
	console.log(`  Working directory: ${workingDir}`);
}

export function logConnected(agentName: string): void {
	console.log(`Discord bot connected: ${agentName}`);
	console.log("");
}
